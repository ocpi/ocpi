...
|parking |<<types.asciidoc#types_cistring_type,CiString>>[36] |+ |A reference to the parking space or spaces that can be used by vehicles charging at this EVSE. The strings in this field refer to <<mod_locations_parking_object,Parking>> objects from the EVSE's Location's <<mod_locations_location_object_parking_places_field,parking_places>> field by their `id` field.
