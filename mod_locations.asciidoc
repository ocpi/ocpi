...
|environ_impact |<<mod_locations_environmentalimpact_class,EnvironmentalImpact>> |* |Key-value pairs (enum + amount) of nuclear waste and/or CO2 exhaust of this location or tariff.
