...
|parking |<<mod_locations_evseparking_class,EVSEParking>> |+ |A reference to the parking space or spaces that can be used by vehicles charging at this EVSE.
...
|parking_restrictions |<<mod_locations_parkingrestriction_enum,ParkingRestriction>> |* |All applicable restrictions on who can park at the EVSE, apart from those related to the vehicle type.
