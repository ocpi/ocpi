...
NOTE: Earlier releases of the OCPI 2.2.1 specification documentation mistakenly gave maximum lengths of 45 and 20 for the  `address` and `state` fields of the Location object.
