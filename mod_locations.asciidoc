...
There is no direct way to delete a location, EVSE or Connector, there are other modules like <<mod_sessions#mod_sessions_sessions_module,`sessions`>> that link to
