...
* A Company that operates public Charge Points, and also provides eMSP service to EV drivers and is running their own software platform. +
  Is seen in OCPI as a Platform that has 2 roles: CPO and eMSP for this company.
* If one the company above starts to offer their service to other CPOs and eMSP, it is still seen as 1 platform,
