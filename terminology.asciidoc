...
|===
|Modules
  |<<credentials.asciidoc#credentials_credentials_role_enum,CPO>>
  |<<credentials.asciidoc#credentials_credentials_role_enum,eMSP>>
  |<<credentials.asciidoc#credentials_credentials_role_enum,Hub>>
  |<<credentials.asciidoc#credentials_credentials_role_enum,NSP>>
  |<<credentials.asciidoc#credentials_credentials_role_enum,NAP>>
  |<<credentials.asciidoc#credentials_credentials_role_enum,SCSP>>
