...
| auth_id                 | [string](types.md#16-string-type)(32) | 1     | Uniquely identifies the EV Driver contract token within the eMSPs platform (and suboperator platforms). Recommended to follow the specification for ContractID in ISO/IEC 15118-2 - Annex H "Specification of Identifiers". |
