...
- Support for Hubs TODO
- Support for Virtual CPO's and eMSP's TODO
- Schedule based Smart Charging (TODO)
...
TODO (Make this list complete, make the items links)

For more information on message level changes see <<changelog.asciidoc#changelog_changelog,changelog>>.
