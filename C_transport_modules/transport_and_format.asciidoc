...
.Example sequence diagram of a GET for 1 Object from a Virtual CPO to Virtual MSP via a Hub
image::images/sd_platform_hub_platform.svg[Example sequence diagram of a GET for 1 Object from a Virtual CPO to Virtual MSP via a Hub]
...
image::images/unique_ids_pair2pair.svg[Example sequence diagram of the uses of X-Request-ID and X-Correlation-ID in a peer-to-peer topology.]

.Example sequence diagram of the uses of X-Request-ID and X-Correlation-ID in a topology with a Hub.
image::images/unique_ids_via_hub.svg[Example sequence diagram of the uses of X-Request-ID and X-Correlation-ID in a topology with a Hub.]
