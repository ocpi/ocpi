...
|RESERVATION_TIME | | Time during this  <<mod_cdrs_chargingperiod_class,ChargingPeriod>> charging station has been reserved and not yet been in use for this customer: defined in hours, default step_size multiplier is 1 second.
