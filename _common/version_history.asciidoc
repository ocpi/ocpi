...
|3.0 Draft 0 |21-06-2019 | Robert de Leeuw +
_ihomer_ |First documentation structure for OCPI 3.0, moved all existing documentation to the new documents
...
|2.1.1-d2 |21-06-2019 | Robert de Leeuw +
                  _ihomer_  |Fixed 4 bugs found in OCPI 2.1, lots of small textual improvements.
|2.1.1 |08-06-2017 | Robert de Leeuw +
                  _ihomer_  |Fixed 4 bugs found in OCPI 2.1, lots of small textual improvements.
|2.1 |08-04-2016 | Robert de Leeuw +
                _ihomer_  |Added command module. +
