...
_EVA Global_ +
Reinier Lamers +
_ihomer_ | Extensively edited and rewrote Tariffs and step+size documentation +
edited URLs in examples and diagrams to consistently not have trailing slashes +
clarified use of Base64 for credentials token +
...
added note about absence of price rounding specifications in Tariffs module +
removed note about sharing Locations for home charging reimbursement from Location object
