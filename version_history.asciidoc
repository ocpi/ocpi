...
|2.2-d2 Draft |05-06-2020 | Robert de Leeuw +
...
- OCPI 2.2-d2 is the same protocol version as OCPI 2.2, but a newer documentation revision: same protocol, newer documentation.
