...
|Version |Date |Author |Description
|1.1 | 2025-12-12 a|
* Ben van Gameren _ihomer_
* Reinier Lamers _SWTCH Energy_
a|
* Removed `LICENSE_PLATE` value from <<mod_tokens_tokentype_enum, TokenType>>
* Multiple schema renames and type changes, see <<changelog.asciidoc#changelog_changelog,changelog>>
* Updated examples and documentation
|1.0 | 2025-06-13 a|
- Boudewijn Groeneboer
_ihomer_
- Niclas Rinman
_Volvo_ a|
* Add Bookings Module
