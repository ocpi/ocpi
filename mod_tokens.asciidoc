...
|<<mod_tokens_locationreferences_class,LocationReferences>> |? |Location and EVSEs/Connectors for which the Token is requested to be authorized.
|===
...
|evse_uids |<<types.asciidoc#types_cistring_type,CiString>>(36) |* |Unique identifier for EVSEs within the CPO's platform for the EVSE within the given location.
