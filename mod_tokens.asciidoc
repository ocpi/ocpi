...
|token_uid |<<types.asciidoc#types_cistring_type,CiString>>(36) |yes |Token.uid of the Token for which this authorization is.
...
|evse_uids |<<types.asciidoc#types_cistring_type,CiString>>(36) |* |Unique identifier for EVSEs within the CPO's platform for the EVSE within the the given location.
|connector_ids |<<types.asciidoc#types_cistring_type,CiString>>(36) |* |Identifies the connectors within the given EVSEs. |
|===
