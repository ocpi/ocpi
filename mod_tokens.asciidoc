...
|LICENSE_PLATE | The option to communicate the license plate as a Token. This should not be used for just starting a session and be use to reserve a <<mod_bookings_bookinglocation_object, BookingLocation>>.
