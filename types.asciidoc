...
When naming new OpenEnum values, OCPI implementers SHOULD follow the "Recommendations for Creators of New Parameters" found in https://datatracker.ietf.org/doc/html/rfc6648[IETF RFC 6648].
