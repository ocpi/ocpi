...
|signed_data |<<types.asciidoc#types_cistring_type,CiString>>(5000) |1 |Blob of signed data, base64 encoded. The format of the content depends on the EncodingMethod field.
|===
