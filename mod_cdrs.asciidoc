...
NOTE: Earlier releases of the OCPI 2.2.1 specification documentation mistakenly gave a maximum length of 512 for the `plain_data` field of the SignedValue class.
