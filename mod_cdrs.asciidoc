...
|booking_id |<<types.asciidoc#types_cistring_type,CiString>>(36) |? |Unique ID of the Booking for which this cdr can also be sent. Is only allowed to be omitted when the CPO when the Session was reserved.
