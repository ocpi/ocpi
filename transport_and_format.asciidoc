...
When extending OCPI with such non-specified fields, implementers:
  ...
  * SHOULD choose meaningful field names that are currently unused to the best of their knowledge, and
  * SHOULD NOT use name prefixes like "x-" or "custom" to indicate the non-specified nature of these field names.
