...
.Example sequence diagram of the uses of X-Request-ID and X-Correlation-ID in a pair-to-pair topology.
image::images/unqiue_ids_pair2pair.svg[Example sequence diagram of the uses of X-Request-ID and X-Correlation-ID in a pair-to-pair topology.]
