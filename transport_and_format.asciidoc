...
.Example sequence diagram of a GET for 1 Object from a Virtual CPO to Virtual MSP directly (without a Hub)
image::images/sd_virtual_virual_direct.svg[Example sequence diagram of a GET for 1 Object from a Virtual CPO to Virtual MSP directly (without a Hub]
