...
=== OCPI {ocpi_version} Introduction

This document is the introduction to OCPI {ocpi_version}.

TODO

==== Editorial note
This is the first documentation structure for the new OCPI {ocpi_version}.
This is OCPI {document_version}. A lot of work still needs to be done, this version is for show how the documentation structure will look.
