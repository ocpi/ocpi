...
|Minimal / +
Minimal
|added new values for: `BIKE_SHARING`, `PARKING_LOT` and `TRAM_STOP`.
...
|Minimal / +
Minimal
|Added value `APP_USER`. As more and more eMSPs are launching Apps, this becomes more common, so a special category is useful.
