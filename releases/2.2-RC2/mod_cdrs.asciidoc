...
|url                     | <<types.asciidoc#types_cistring_type,CiString>>(512) |? |Link to portal where an EV driver can check the data from a charging session. (TODO: better description)
|===
