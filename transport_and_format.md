...
|----------------|---------------------------------------|-------|-----------------------------------------------------------|
| data           | Array or Object                       | ?     | Contains the actual response data object or list of objects from each request, depending on the cardinology of the response data, this is an array (card. * or +), or a single object (card. 1 or ?) |
