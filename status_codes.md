...
| 3003 | No matching endpoints or expected endpoints missing between parties. Used during the handshake process if the two parties do not have any mutual modules or endpoints available. |
<div><!-- ---------------------------------------------------------------------------- --></div>
