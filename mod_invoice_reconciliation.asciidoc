...
When a CPO or eMSP deletes an Invoice Reconciliation record, they will call the <<mod_invoice_reconciliation_receiver_delete_method,DELETE>> on the Invoice Reconciliation endpoint. Deleting an Invoice Reconciliation Record indicates that the record itself was an error. Errors in the referenced invoice or in the listed CDRs can be resolved by sending an updated Invoice Reconciliation Record.
...
`+https://www.server.com/ocpi/cpo/2.3.0/invoicereconciliation/?date_from=2019-01-28T12:00:00&date_to=2019-01-29T12:00:00+`

`+https://ocpi.server.com/2.3.0/invoicereconciliation/?offset=50+`

`+https://www.server.com/ocpi/2.3.0/invoicereconciliation/?date_from=2019-01-29T12:00:00&limit=100+`

`+https://www.server.com/ocpi/cpo/2.3.0/invoicereconciliation/?offset=50&limit=100+`
...
`+https://www.server.com/ocpi/2.3.0/invoicereconciliation+`
