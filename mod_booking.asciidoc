...
include::examples/booking_patch_example_tokens.json[]
----
...
include::examples/booking_patch_example_timeslot.json[]
----
...
|<<mod_locations_get_method_eMSP,GET>> | Retrieves BookingLocations or Calendar as stored in the eMSP system. |POST |n/a _(use <<mod_locations_put_method,PUT>>)_
...
===== PUT BookingLocation calender: Response Data
