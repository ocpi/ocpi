...
- The total for this charging session is therefore *0.50 euro* (excl. VAT).
...
- The 2 minutes of (`PARKING_TIME`) are after 20:00, so they are free.
- The total for this charging session is therefore *0.60 euro* (excl. VAT).
