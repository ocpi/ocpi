...
The Credentials module is different from all other OCPI modules. This module does not have a `Sender` and a `Receiver` interface.
...
this module on any other party.
