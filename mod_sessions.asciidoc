...
|start_date_time |<<types.asciidoc#types_datetime_type,DateTime>> |1 |The time when the session became active.
|end_date_time |<<types.asciidoc#types_datetime_type,DateTime>> |? |The time when the session was completed.
